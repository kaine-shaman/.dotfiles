...
keymap.set("n", "<leader>bb", "<cmd>e#<cr>"         , { desc = "Switch to Other [B]uffer", noremap = true, silent = true })
keymap.set("n", "<leader>be", "<cmd>bd|e#<cr>"      , { desc = "Reload buffer"           , noremap = true, silent = true })
