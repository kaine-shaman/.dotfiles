return {
    ...
    config = function()
        ...
        keymap.set("n", "<leader>fs", "<cmd>FzfLua<cr>", { desc = "[S]elect source" })

        keymap.set("n", "<leader>ff", "<cmd>FzfLua files<cr>"      , { desc = "[F]iles"          })
        keymap.set("n", "<leader>f.", "<cmd>FzfLua oldfiles<cr>"   , { desc = "[.] Recent files" })
        keymap.set("n", "<leader>fm", "<cmd>FzfLua marks<cr>"      , { desc = "[M]arks"          })
        keymap.set("n", "<leader>fh", "<cmd>FzfLua helptags<cr>"   , { desc = "[H]elp"           })
        keymap.set("n", "<leader>fk", "<cmd>FzfLua keymaps<cr>"    , { desc = "[K]eymaps"        })

        keymap.set("n", "<leader>fd", "<cmd>FzfLua diagnostics_workspace<cr>", { desc = "[D]iagnostics" })

        keymap.set({ "n", "v" }, "<leader>fv", "<cmd>FzfLua grep_visual<cr>", { desc = "[V]isual" })

        keymap.set("n", "<leader>fg", "<cmd>FzfLua live_grep<cr>"   , { desc = "[G]rep"           })
        keymap.set("n", "<leader>fc", "<cmd>FzfLua lgrep_curbuf<cr>", { desc = "[C]urrent buffer" })
        keymap.set("n", "<leader>fw", "<cmd>FzfLua grep_cword<cr>"  , { desc = "[w]ord"           })
        keymap.set("n", "<leader>fW", "<cmd>FzfLua grep_cWORD<cr>"  , { desc = "[W]ord"           })

        keymap.set("n", "<leader>fr", "<cmd>FzfLua resume<cr>", { desc = "[R]esume searching" })

        keymap.set("n", "<leader>gc", "<cmd>FzfLua git_commits<cr>" , { desc = "git all [C]ommits"           })
        keymap.set("n", "<leader>gf", "<cmd>FzfLua git_bcommits<cr>", { desc = "git current [F]file commits" })
        keymap.set("n", "<leader>gd", "<cmd>FzfLua git_status<cr>"  , { desc = "git status [D]iff"           })
        keymap.set("n", "<leader>gs", "<cmd>FzfLua git_stash<cr>"   , { desc = "git [S]tash"                 })
        keymap.set("n", "<leader>gb", "<cmd>FzfLua git_blame<cr>"   , { desc = "git [B]lame"                 })
        ...
        keymap.set("n", "gd", "<cmd>FzfLua lsp_definitions<cr>", { desc = "Goto [D]efinition" })

        -- Find references for the word under your cursor.
        keymap.set("n", "gr", "<cmd>FzfLua lsp_references<cr>", { desc = "Goto [R]eferences" })

        -- Jump to the implementation of the word under your cursor.
        --  Useful when your language has ways of declaring types without an actual implementation.
        keymap.set("n", "gI", "<cmd>FzfLua lsp_implementations<cr>", { desc = "Goto [I]mplementation" })

        -- Jump to the type of the word under your cursor.
        --  Useful when you're not sure what type a variable is and you want to see
        --  the definition of its *type*, not where it was *defined*.
        keymap.set("n", "<leader>ld", "<cmd>FzfLua lsp_typedefs<cr>", { desc = "Type [D]efinition" })

        -- Fuzzy find all the symbols in your current document.
        --  Symbols are things like variables, functions, types, etc.
        keymap.set("n", "<leader>ls", "<cmd>FzfLua lsp_document_symbols<cr>", { desc = "Document [S]ymbols" })

        -- Fuzzy find all the symbols in your current workspace
        --  Similar to document symbols, except searches over your whole project.
        keymap.set("n", "<leader>lws", "<cmd>FzfLua lsp_workspace_symbols<cr>", { desc = "Workspace [S]ymbols" })

        -- TODO: check the list of potential sources
        -- changes
        -- colorschemes
        -- command_history
        -- commands
